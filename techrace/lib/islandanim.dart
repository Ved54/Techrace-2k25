                    ...
                    ConstrainedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Obx(() => !homeController2.isLoading.value ? const SizedBox() : Container(padding: const EdgeInsets.only(top: 8, bottom: 8, right: 16), child: CircularProgressIndicator(color: Colors.white.withOpacity(0.75),)))
                        ...
                        ? Container(
                            ...
                            child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                    ...
                                    backgroundColor: const Color(0xff222257),
                                    minimumSize: Size(
