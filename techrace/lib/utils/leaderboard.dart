...
class _LeaderBoardState extends State<LeaderBoard> {
  ...
  Map sortMap(map) {
    ...
    entries.sort((a, b) {
      // if anything is null then don't compare

      if (a.value["current_clue_no"] == null ||
          b.value["current_clue_no"] == null ||
          a.value["prev_clue_solved_timestamp"] == null ||
          b.value["prev_clue_solved_timestamp"] == null ||
          a.value["balance"] == null ||
          b.value["balance"] == null) {
        return 0;
      }
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                '$teamId, ${(data['current_clue_no'] == finalClue) ? "Finished Game" : "Clue ${data['current_clue_no']}"}',
                                style: TextStyle(
                                    color: Colors.white.withOpacity(0.5),
                                    fontSize: 10),
                              ),
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  showPowerCardUseConfirmation(powerUp)
                      .then((value) => Get.back());
                },
                child: Container(
                  decoration: BoxDecoration(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        onPressed: () {
                          ...
                          // if (powerUp == PowerUps.guessLocation && false) {
                            homeController.guessedString.text = "";
                            // guessLocDialog();
                            homeController.guessedLocationFunction();
                            return;
