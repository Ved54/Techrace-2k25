...
class _ValidateState extends State<Validate>
  ...
  final RxBool isCamScan = false.obs;
  ...
  late ValidationController valController;
  ...
  void initState() {
    ...
    _controller.forward();
    valController = Get.find();
    // print(ValidationController.fbChild);
      ...
      (RangingResult result) async {
        ...
        if (result.beacons.isNotEmpty) {
          ...
          for (var element in result.beacons) {
            ...
            //   tCode = '$tCodeInt';
            // }
            String tCode = element.proximityUUID.substring(33);
                      ...
                      for (final barcode in barcodes) {
                        ...
                        if (barcode.rawValue != null &&
                         ...
                         final String teamId = barcode.rawValue!;
                          ...
                          String updateCheck = await updateDB(ref, teamId)
                              .timeout(const Duration(seconds: 5), onTimeout: () {
                            return 'Timeout';
                          });
                          if (!mounted) return;
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () async {
                              validating.value = true;
                              updateCheck =
                                  await updateDB(ref, teamCodes[index])
